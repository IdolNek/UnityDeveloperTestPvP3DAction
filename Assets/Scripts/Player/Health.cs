...
public class Health : NetworkBehaviour
{
    ...
    [SerializeField] private float _isDamagedÑountdownTime;
    ...
    private void SetHealth(float newValue)
    {
        ...
        if (_currentHeath == 0)
        {
            ...
            Debug.Log($"Ïðîâåðêà âñå óìåðëè? = { RoundEvent.GetInstance().IsGameOver()}");
    ...
    public void ApplyDamage(float damage)
    {
        ...
        StartCoroutine(ÑountdownIsDamaged());
    }

    IEnumerator ÑountdownIsDamaged()
    {
